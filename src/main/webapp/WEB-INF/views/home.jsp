		...
		<div class="row">
			<div class="mypage-header-container">
				<div class="mypage-header-profile">
					<img class="center round-profile-150" src="img/avatar.png" />
				</div>
				<div class="mypage-header-user"><h3>Warrior의 페이지</h3></div>
			</div>
		</div>
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="profile">
				...
				<div class="col-md-3 mypage-profile-picture">
					<img class="round-profile-150" src="img/avatar.png" />
				...
				<div class="col-md-8 mypage-profile-details">
					...
					<tr>
						<td>닉네임</td>
						<td class="align-right">warrior1</td>
					</tr>
					<tr>
						<td>아이디</td>
						<td class="align-right">warrior1</td>
					...
					<tr>
						<td>이메일</td>
						<td class="align-right">warrior1@email.com</td>
					</tr>
					<tr>
						<td>비밀번호 분실 질문</td>
